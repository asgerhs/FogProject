    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:8080/FogProject/FrontController?command=showParts&submit=true&length=780&width=600&shed=true&shedLength=210&shedWidth=600">PartList</a>
                </li>
                <li class="nav-item">
